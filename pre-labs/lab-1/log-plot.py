...
if __name__ == '__main__':
    ...
    for column in range(0, number_of_curves_in_plot):
        plt.plot(diode_readings_x , np.log(diode_readings_y[column]), label = "Regular Diode", color="orange")
        plt.plot(blue_readings_x , np.log(blue_readings_y[column]), label = "Blue LED", color="blue")
        plt.plot(green_readings_x , np.log(green_readings_y[column]), label = "Green LED", color="green")
        plt.plot(red_readings_x , np.log(red_readings_y[column]), label = "Red LED", color="red")
        plt.plot(white_readings_x , np.log(white_readings_y[column]), label = "White LED", color="black")
    ...
    plt.legend()
    plt.savefig("plots/diode-iv-log.png")
    plt.show()