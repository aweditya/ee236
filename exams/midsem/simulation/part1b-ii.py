...
filenames    = ["results/part1-b-0.5", "results/part1-b-1.0", "results/part1-b-1.5", "results/part1-b-2.0", "results/part1-b-2.5", "results/part1-b-3.0"]
Plot_Title   = "Part 1b ii"
...
if __name__ == '__main__':
    ...
    for column in range(0, number_of_curves_in_plot):
        plt.plot(readings_25_x , readings_25_y[column], label = r"0.5mA")
        plt.plot(readings_35_x , readings_35_y[column], label = r"1.0mA")
        plt.plot(readings_45_x , readings_45_y[column], label = r"1.5mA")
        plt.plot(readings_55_x , readings_55_y[column], label = r"2.0mA")
        plt.plot(readings_65_x , readings_65_y[column], label = r"2.5mA")
        plt.plot(readings_75_x , readings_75_y[column], label = r"3.0mA")
